package com.example.processor.codegeneration
...
class AdapterCodeBuilder(private val adapterName: String, private val data: ModelData) {
    ...
    private fun TypeSpec.Builder.addBaseMethods(): TypeSpec.Builder = apply {
        ...
        addFunction(
            FunSpec.builder("onCreateViewHolder")
                ...
                .addStatement(
                    "val view = android.view.LayoutInflater.from(parent.context).inflate(%L, " +
    ...
    private fun TypeSpec.Builder.addBindingMethod(): TypeSpec.Builder =
        addFunction(
            FunSpec.builder("bind")
                .addParameter("item", modelClassName).apply {
